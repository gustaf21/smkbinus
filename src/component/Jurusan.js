            ...
            <div>
                    ...
                    <Mui.Container fidex>
                        <Mui.Grid container spacing={1}>
                            ...
                            <img src="/tkj.jpeg" width="500" height="300"></img>
                            ...
                            <Mui.Grid item xs={12} sm={6}>
                            <img src="/tb.jpg" width="500" height="300"></img>
                    ...
                    <Mui.Container fidex>
                        <Mui.Grid container spacing={1}>
                            <Mui.Grid item xs={12} sm={6}>
                            <img src="/motor.jpeg" width="500" height="300"></img>
                            ...
                            <Mui.Grid item xs={12} sm={6}>
                            <img src="/akl.jpeg" width="500" height="300"></img>
